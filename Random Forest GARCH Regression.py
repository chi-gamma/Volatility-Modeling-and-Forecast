...
predict_rf = predict_rf[:-m]
predict_rf = pd.DataFrame(predict_rf)
predict_rf.index = rets.iloc[m-n:].index

#===============================================================================================================================================================================#
#=================================================================== calculate the RMSE of the predictions =====================================================================#

rmse_rf = np.sqrt(mean_squared_error(real_vol.iloc[m-n:] / 100, predict_rf / 100))
